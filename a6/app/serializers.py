...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ('id', 'code', 'description', 'price', 'category_id', 'category', 'category_name',)
...
class CategoryProductSerializer(serializers.ModelSerializer):
    ...
    product_price = serializers.DecimalField(max_digits=15, decimal_places=5, source = 'product.price', read_only = True)
